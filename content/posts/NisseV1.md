...
All the code for this article is in a single [file](https://github.com/Loki-Astari/NisseBlogCode/blob/master/NisseOrigins/NisseV1.cpp). It uses only the standard libraries should be easy to build by anybody.
